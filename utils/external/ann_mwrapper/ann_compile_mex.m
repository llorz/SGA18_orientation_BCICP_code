...
%mex(options{:}, ['-I', ann_inc_dir], '-outdir', output_dir, 'private/ann_build_tree.cpp', src_paths{:});

%mex(options{:}, ['-I', ann_inc_dir], '-outdir', output_dir, 'private/ann_query_tree.cpp', src_paths{:});
