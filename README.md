...
(2) *2020-Feb*: Thank you **@rFalque (Raphael Falque)** for sharing this info: you can find a faster **linux** version of the fastmarchmex [here](https://github.com/abbasloo/dnnAuto/blob/master/preprocessing/isc/fastmarchmex.mexa64)
